...
<div style="width:60%;margin:1%;float:left;">
    ...
    <h3>Arcanoeil</h3>
    <img class="communImages" style="max-height:80px;float:left;margin-right:10px;" src="ressources/11-Monstres/Icones/ether-cyclops.png" title="Illustration : Lorc, Open Game Art">
