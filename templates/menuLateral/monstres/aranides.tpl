...
<div style="width:68%;margin:1%;float:left;">
    ...
    <img class="communImages" style="max-height:80px;float:left;margin:10px;" src="ressources/11-Monstres/Icones/aran-mandib.png" title="Illustration : Lorc, Open Game Art">
...
<div style="width: 28%; margin: 1%; float:left;">
    ...
    <p class="pImageRace">Une sentinelle aranide</p>
</div>
