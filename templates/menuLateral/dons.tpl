...
<div class="divTiersGauche">
    <h2 id="idDon01">Les dons de sauvegarde</h2>

    <div id="idDon11" class="zoneDons">
        <img class="communImages imageLogoDon" src="ressources/06-Dons/SauvegardeFeindre.png" title="Illustration : Lorc, Open Game Art">
        <h3 class="h3Alignement">Feindre la mort</h3>
...
<div class="divTiersDroit">
    ...
    <h2 id="idDon03">Les dons de magie</h2>

    <div id="idDon31" class="zoneDons">
