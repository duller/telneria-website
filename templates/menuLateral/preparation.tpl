...
<div class="divMoitieGauche">
    ...
    <img class="communImages" style="max-height:80px;float:left;margin-right:10px;box-shadow:none;" src="ressources/12-Preparation/prep-chateau.png" title="Illustration : Lorc, Open Game Art">
...
<div class="divMoitieDroite">
    ...
    <img class="communImages" style="max-height:80px;float:left;margin:10px 10px 0 0;box-shadow:none;" src="ressources/12-Preparation/prep-chaudron.png" title="Illustration : Lorc, Open Game Art">
