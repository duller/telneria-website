...
<div style="float:left;">
    ...
    <div class="divVoie classesMagie">
        ...
        <h4 class="h4choixClasse">Le sorcier</h4>
    ...
    <div class="divVoie classesFoi">
        ...
        <h4 class="h4choixClasse">Le paladin</h4>
...
<div style="float:left;">
    ...
    <div class="divVoie classesDiscretion">
        ...
        <h4 class="h4choixClasse">Le roublard</h4>
        ...
        <h4 class="h4choixClasse">Le rôdeur</h4>
    ...
    <div class="divVoie classesGuerre">
        ...
        <h4 class="h4choixClasse">Le guerrier</h4>
        ...
        <h4 class="h4choixClasse">Le sombregarde</h4>
