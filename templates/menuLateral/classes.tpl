...
<div style="float:left;">
    ...
    <div class="divVoie classesMagie">
        ...
        <img class="communImages imageLogoClasseChoix" src="ressources/03-Classes/Sorcier.png" title="Illustration : Horror Pen, Open Game Art">
        <h4>Le sorcier</h4>
...
<div style="float:left;">
    ...
    <div class="divVoie classesDiscretion">
        ...
        <img class="communImages imageLogoClasseChoix" src="ressources/03-Classes/Roublard.png" title="Illustration : Horror Pen, Open Game Art">
        <h4>Le roublard</h4>
