...
<div style="float:left;">
    ...
    <div class="divVoie classesMagie">
        ...
        <h4>Le sorcier</h4>
        <p class="pDescriptionClasseChoix">Le <a href="?Page=menuLateral/classes/sorcier">sorcier</a> est un sectateur de magie noire, il cherche continuellement à gagner en 
            puissance et à s'affirmer face à ses compétiteurs. Adeptes du chaos, les sorciers contrôlent les morts-vivants et les démons pour dominer leurs ennemis.</p>
        <br />
