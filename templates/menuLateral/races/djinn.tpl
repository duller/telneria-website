<h2 class="titreRace">Les Djinns</h2>

<div class="descriptionClasse communDivClasseMarges communDivClasseContour">
    <div>

        <img class="communImages imagePaysageRace" src="ressources/04-Races/PaysageDjinn_Wikimedia.jpg" style="max-width:65%;" title="Illustration : Wikimedia">
    ...
    <div class="divDescrRace">
        ...
        <div class="divMoitieGauche divDescriptionRaceOmbre">
            ...
            <p><span class="titreDebutLigne">Langue maternelle</span> &nbsp: Arabique</p>
            <p><span class="titreDebutLigne">Langues secondaires</span> &nbsp: Copte</p>
        </div>
