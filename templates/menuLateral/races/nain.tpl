...
<div class="descriptionClasse communDivClasseMarges communDivClasseContour">
    ...
    <div class="divDescrRace">
        ...
        <p class="pDescriptionClassesDispo">Triées par la population de chaque classe. Un guerrier nain est assez commun, tandis qu'un druide est plutôt rare.</p> 
...
<div class="classeImage communDivClasseMarges">
    <p class="pImageRace"><img class="imagePersonnage" src="ressources/04-Races/cartes/nain.jpg" title="Illustration : François Ripp"></p>
