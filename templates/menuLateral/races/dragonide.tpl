...
<div class="descriptionClasse communDivClasseMarges communDivClasseContour">
    <div>
        ...
        <img class="communImages imagePaysageRace" src="ressources/04-Races/PaysageDragonide_AugustWilhelmLeu.jpg" style="max-width:70%;" title="Illustration : August Wilhelm Leu">
