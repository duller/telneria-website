<h1>Le monde de Telneria</h1>

<p><img class="imageCarte" src="ressources/CarteMonde.jpg"></p>

<h3>Istnor</h3>
<p>Petite île au nord-ouest de Telneria, Istnor est une contrée froide et peu habitée.</p>
<p>Elle est la terre d'origine des Chepteg dans les forêts au nord de l'île et des Varelias au sud. La plus grande cité de l'île est Istville, une ville de taille moyenne abritant les aînés des Varelias.</p>
...
<p>Le sud du continent se compose des belliqueuses baronnies humaines veldriennes. Vesnoth, à l'ouest, est la capitale des baronnies et le siège du prince régnant ; 
    on trouve également dans cette baronnie la cité des telnastres de Maldaran ainsi que la grande cité commerciale de Brill. Les autres baronnies sont inféodés au souverain de Vesnoth : ce sont les baronnies de Vilnus, Temberg, Valmer
et Estrhan.</p>
...
<p>L'île est coupée en trois régions par deux grandes murailles. À l'ouest, on trouve les terres des Kerfenn et leur capitale Kerbourg. Au centre on trouve le carnumat humain de Carnum ;
...
<h3>La monnaie</h3>
<p>De nombreuses monnaies locales sont utilisées sur les quatre continents de Telneria, elles sont généralement en minerai rare tel l'or ou l'argent, et n'ont que rarement des effigies.
