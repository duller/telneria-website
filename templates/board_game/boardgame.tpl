...
<div class="divTitreClasse">
    <h1 class="titreClasse">Le jeu de plateau</h1>
</div>
...
<div class="descriptionClasse communDivClasseMarges communDivClasseContour">
    ...
    <div class="divInterneClasse">
        <div class="divSortTechnique divSortTechniqueDescription">
            <h4 class="h4ClassePerso">Règles</h4>
            <p>Les règles du jeu et les tableaux des valeurs de combat.</p>
            <div class="divInterneClasse">
                <a class="pdfFichePerso" href="ressources/pdfboardgame/boardgame.pdf">Régles du jeu</a>
            </div>
        </div>

        <div class="divSortTechnique divSortTechniqueDescription">
            <h4 class="h4ClassePerso">Fiches de personnages</h4>
            <p>Fiches des personnages jouables.</p>
            <div class="divInterneClasse">
                <a class="pdfFichePerso" href="ressources/pdfboardgame/persos.pdf">Fiches de personnage</a>
            </div>
        </div>
    </div>
...
<div class="classeImage communDivClasseMarges" style="margin-top:-30px;">
    <p class="pImageRace"><img class="imagePersonnage" src="ressources/01-Accueil/large_board.png" title="Illustration : François Ripp"></p>
    <p class="pImageRace">Une table de taille tout à fait normale</p>
</div>
